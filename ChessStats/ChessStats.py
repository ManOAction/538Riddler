...
TournamentURL = "https://api.chess.com/pub/tournament/fischer-nonrandom"
headers = {
...
def AnalyzeGamePlayingTime(GameNumber, driver):    
    ...
    for move in soup.find_all('div', class_='move'):        
        white_move_time = move.find('div', class_='time-white')['data-time'] if move.find('div', class_='time-black') else None
        if white_move_time:
